        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.2fr_2fr] gap-8 md:gap-20 pb-10 border-b border-neutral-700 items-start">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-4 items-center">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/elovientofficial/" onClick={() => trackSocialBtnClick("Facebook")} target="_blank" rel="noopener noreferrer" className="hover:text-primary-400 transition cursor-pointer flex items-center justify-center" style={{ width: 35, height: 35 }}>
